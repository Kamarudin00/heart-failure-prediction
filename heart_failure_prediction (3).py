...
# Misalnya, jika model Random Forest terbaik Anda bernama 'tuned_rf_model'
...
# Pastikan untuk melatih model ini jika belum dilatih
tuned_rf_model.fit(X_train, y_train)

# Simpan model ke dalam file .pkl
joblib.dump(tuned_rf_model, 'heart_failure_model.pkl')
print("Model berhasil disimpan sebagai heart_failure_model.pkl")
